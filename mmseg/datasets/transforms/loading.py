...
class LoadAnnotations_bgra(MMCV_LoadAnnotations):
    ...
    def _load_seg_map(self, results: dict) -> None:
        ...
        '''
        if results['seg_map_path'] == '/mnt/data/lanxing/FOOD_CORRECT_SEG_DATASETS/UECFoodPIXCOMPLETE/test/mask/3060.png':
            import cv2
            data = cv2.imread(results['seg_map_path'])
            print(gt_semantic_seg == data[-1]).all()
        '''
        ...
        #results['gt_seg_map'] = gt_semantic_seg[:,:,-1]
