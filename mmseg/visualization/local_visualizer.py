...
class SegLocalVisualizer(Visualizer):
    ...
    def add_datasample(
        ...
        '''
        import cv2
        cv2.imwrite('/home/lanxing/mmsegmentation/tools/img.png', mmcv.rgb2bgr(image))
        cv2.imwrite('/home/lanxing/mmsegmentation/tools/gt_mask.png', mmcv.rgb2bgr(gt_img_data))
        cv2.imwrite('/home/lanxing/mmsegmentation/tools/pred_mask.png', mmcv.rgb2bgr(pred_img_data))
        '''
